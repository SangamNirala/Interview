...
const PlacementPreparationDashboard = ({ setCurrentPage }) => {
  ...
  // Technical Interview Questions state
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="mt-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        <button
                          className="bg-gradient-to-r from-cyan-600 to-teal-600 text-white font-semibold py-3 px-4 rounded-lg hover:from-cyan-700 hover:to-teal-700 transition-all duration-300 text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                          onClick={handleBehavioralInterviewQuestionsAnalysis}
                          disabled={behavioralLoading}
                        >
                          {behavioralLoading ? '⏳ Generating...' : '🗣️ Behavioural Interview Questions'}
                        </button>
                      </div>
                    </div>
                  </div>
      ...
      {/* Technical Interview Questions Analysis Success Popup */}
      {showTechnicalPopup && technicalAnalysisId && (
        <div className="fixed inset-0 bg-black/75 flex items-center justify-center z-50 p-4">
          <div className="bg-gradient-to-br from-orange-900/90 to-yellow-900/90 backdrop-blur-lg rounded-2xl border border-white/20 max-w-2xl w-full">
            <div className="p-8 text-center">
              <div className="text-6xl mb-4">💻</div>
              <h2 className="text-3xl font-bold text-white mb-4">Technical Interview Questions Generated!</h2>
              <p className="text-white/80 text-lg mb-6">
                Your comprehensive technical interview questions have been successfully generated and are ready for download.
              </p>
              ...
              <div className="space-x-4">
                <button
                  ...
                  className="bg-gradient-to-r from-orange-600 to-yellow-600 text-white font-semibold py-3 px-6 rounded-lg hover:from-orange-700 hover:to-yellow-700 transition-all duration-300"
                >
                  View Results
                </button>
                <button
...
function App() {
  ...
  // Test Completion & Submission Phase (Task 2.3.5)
  if (showTestCompletion) {
    const answeredCount = Object.keys(selectedAnswers).length;
    const unansweredCount = testQuestions.length - answeredCount;
    const reviewCount = markedForReview.size;
    
    // Get unanswered questions list
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-800">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-gray-300">Review your responses before final submission</p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 mb-8">
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-green-500/20 border border-green-500/30 rounded-lg p-6 text-center">
                  ...
                  <div className="text-green-200">Total Answered</div>
                </div>
                ...
                <div className={`${unansweredCount > 0 ? 'bg-red-500/20 border-red-500/30' : 'bg-gray-500/20 border-gray-500/30'} border rounded-lg p-6 text-center`}>
                  ...
                  <div className={`${unansweredCount > 0 ? 'text-red-200' : 'text-gray-300'}`}>Unanswered</div>
                </div>
                
                {/* Marked for Review */}
                <div className={`${reviewCount > 0 ? 'bg-yellow-500/20 border-yellow-500/30' : 'bg-gray-500/20 border-gray-500/30'} border rounded-lg p-6 text-center`}>
                  <div className={`text-3xl font-bold mb-2 ${reviewCount > 0 ? 'text-yellow-300' : 'text-gray-300'}`}>
                    {reviewCount}
                  </div>
                  <div className={`${reviewCount > 0 ? 'text-yellow-200' : 'text-gray-300'}`}>Marked for Review</div>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                {unansweredCount > 0 && (
                  <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4">
                    <h3 className="font-semibold text-red-300 mb-3">Unanswered Questions:</h3>
                ...
                {reviewCount > 0 && (
                  <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-4">
                    <h3 className="font-semibold text-yellow-300 mb-3">Marked for Review:</h3>
                    <div className="text-yellow-200 text-sm">
                      Questions {reviewQuestions.join(', ')}
                    </div>
                  </div>
                )}
              </div>
            ...
            {(unansweredCount > 0 || reviewCount > 0) && (
              <div className="bg-orange-500/20 border border-orange-500/30 rounded-lg p-6 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-orange-300 mb-2">Attention Required</h3>
                    <div className="text-orange-200 text-sm space-y-1">
                      {unansweredCount > 0 && (
                        <p>• You have {unansweredCount} unanswered question{unansweredCount !== 1 ? 's' : ''}. These will be marked as incorrect.</p>
                      )}
                      {reviewCount > 0 && (
                        <p>• You have {reviewCount} question{reviewCount !== 1 ? 's' : ''} marked for review. You can still submit without reviewing them.</p>
                      )}
                      <p className="font-medium mt-2">Once submitted, you cannot modify your answers.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-lg p-6 mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-white font-medium">{Math.floor(timeTaken / 60)} minutes {timeTaken % 60} seconds</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-300">Completion Rate:</span>
                  <span className="text-white font-medium">{Math.round((answeredCount / testQuestions.length) * 100)}%</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-300">Review Rate:</span>
                  <span className="text-white font-medium">{Math.round((reviewCount / testQuestions.length) * 100)}%</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-center gap-6">
              ...
              {/* Submit Test Confirmation Button */}
              <button
                onClick={() => {
                  const message = unansweredCount > 0 
                    ? `Are you sure you want to submit? You have ${unansweredCount} unanswered questions that will be marked as incorrect.`
                ...
                className="px-8 py-3 rounded-lg font-bold bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white transition-all duration-300 shadow-lg hover:shadow-xl"
              >
                🚀 Submit Test
              </button>
            </div>
            ...
            <div className="text-center mt-8">
              <p className="text-gray-400 text-sm">
                💡 Take your time to review. Once submitted, you cannot make changes to your answers.
              </p>
            </div>
          </div>
        </div>
  ...
  // Test Results Display Phase (NEW - After Task 2.3.5)
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-800">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-gray-300">Your aptitude assessment has been completed</p>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 mb-8">
              <div className="text-center mb-8">
                ...
                <div className="text-lg text-gray-300 mb-4">
                  Performance Level: <span className="font-semibold text-white">{performanceLevel}</span>
                </div>
                <div className="inline-flex items-center px-4 py-2 bg-blue-500/20 border border-blue-500/30 rounded-full">
                  <span className="text-blue-200">{percentile}th Percentile</span>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-400">out of 90 minutes</div>
                </div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-400">{Math.round((answeredCount/totalQuestions)*100)}% completion</div>
                </div>
                
                <div className="text-center">
                  <div className="text-2xl font-bold text-white mb-1">
                    {Math.round((correctAnswers/answeredCount)*100) || 0}%
                  </div>
                  <div className="text-gray-300">Accuracy Rate</div>
                  <div className="text-sm text-gray-400">of attempted questions</div>
                </div>
              </div>
            </div>
                  ...
                  return (
                    <div key={topic} className="bg-white/5 rounded-lg p-6">
                      ...
                      <div className="text-sm text-gray-300">
                        {performance.total > 0 ? (
                          <>
                            <span className="font-medium text-white">{performance.correct} correct</span> out of {performance.total} questions
                          </>
                        ) : (
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    {scorePercentage >= 80 && (
                      <div className="text-green-200">• Excellent overall performance across all topics</div>
                    )}
                    {Object.entries(topicPerformance).map(([topic, perf]) => {
                      const pct = perf.total > 0 ? Math.round((perf.correct / perf.total) * 100) : 0;
                      if (pct >= 70) {
                        return (
                          <div key={topic} className="text-green-200">
                            • Strong performance in {topic} ({pct}%)
                          </div>
                        );
                      }
                      return null;
                    ...
                    {answeredCount === totalQuestions && (
                      <div className="text-green-200">• Completed all questions within time limit</div>
                    )}
                    {timeTaken < 4500 && ( // Less than 75 minutes
                      <div className="text-green-200">• Efficient time management</div>
                    )}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    {Object.entries(topicPerformance).map(([topic, perf]) => {
                      ...
                      if (pct < 60) {
                        return (
                          <div key={topic} className="text-orange-200">
                            • Focus on improving {topic} skills ({pct}%)
                          </div>
                        );
                      }
                      return null;
                    ...
                    {answeredCount < totalQuestions && (
                      <div className="text-orange-200">
                        • Consider allocating more time to complete all questions
                      </div>
                    )}
                    {scorePercentage < 60 && (
                      <div className="text-orange-200">
                        • Practice more questions to improve overall accuracy
                      </div>
                    )}
                  </div>
                </div>
            ...
            <div className="flex justify-center gap-6">
              ...
              <button
                onClick={() => {
                  // Reset all test states for a new attempt
                ...
                className="px-8 py-3 rounded-lg font-bold bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700 text-white transition-all duration-300 shadow-lg hover:shadow-xl"
              >
                Take Another Test
              </button>
            </div>
            ...
            <div className="text-center mt-8">
              <p className="text-gray-400 text-sm">
                🎓 Thank you for taking the aptitude assessment. Your results have been recorded.
              </p>
            </div>
          </div>
        </div>
